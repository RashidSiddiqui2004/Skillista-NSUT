...
const RegisterShePage = () => {
    ...
    const registerAsSkillster = async () => {
        ...
        try {
            ...
            if (password.length < 6) {
                toast.info("Password length should be atleast 6!", {
                    position: "top-right",
                    autoClose: 800,
                    hideProgressBar: true,
                    closeOnClick: true,
    ...
    return (
        <div className='mx-auto px-4 py-8 font1 overflow-hidden'>
             ...
             flex flex-col sm:flex-row  mx-auto sm:px-10 py-8 border-2'>
                ...
                <div className='w-full sm:w-[60vw]'>
                    ...
                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='name' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Name</label>
                        <input type="text" id='name' value={fullName} className='bg-inherit text-slate-200 
            border-b border-slate-800 outline-none sm:px-2 rounded-md mx-[10vw] sm:mx-0 w-[60vw] sm:w-[30vw] 
             focus:border-blue-500' placeholder="Your good name?" onChange={(e) => { setFullName(e.target.value) }}
                        />
                    </div>
                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='email' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Email</label>
             ...
             border-b border-slate-800 outline-none sm:px-2 rounded-md mx-[10vw] sm:mx-0 w-[60vw] sm:w-[30vw] 
              focus:border-blue-500' placeholder='Enter your email' onChange={(e) => { setEmail(e.target.value) }}
                    ...
                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='password' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Password</label>
             ...
             border-b border-slate-800 outline-none sm:px-2 rounded-md mx-[10vw] sm:mx-0 w-[60vw] sm:w-[30vw] 
              focus:border-blue-500' placeholder='Enter your password' onChange={(e) => { setPassword(e.target.value) }}
                    ...
                    <p className='text-white text-sm mb-2'>Password length should be atleast 6 characters.</p>

                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='domain' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0  sm:w-[18%]'>Select Domain</label>
              ...
              focus:border-blue-500' value={selectedDomain} onChange={(e) => setSelectedDomain(e.target.value)}>
                    ...
                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='experience' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Experience</label>
                    ...
                    <div className='mb-5 flex flex-col sm:flex-row gap-4'>
                        <label htmlFor='experience' className='text-white text-lg mb-1 w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Bio/About You</label>
                        <textarea
                            id='bio'
                            value={bio}
                            style={{ height: '8rem' }} // Set the height using the style attribute
                            className='bg-inherit text-slate-200 border
                             border-slate-700 outline-none px-2 sm:px-2 py-2 rounded-md 
                              w-[80vw] sm:w-[30vw] focus:border-blue-500 mx-[5vw] sm:mx-0'
                    ...
                    <div className="mt-4">
                        <h2 className='text-white flex justify-start text-xl mb-4 font-semibold ml-3  
                        w-full text-start mx-[10vw] sm:mx-0 sm:w-[18%]'>Skills</h2>
                        ...
                        <input
                            ...
                            className=' bg-inherit mb-4 px-4 py-2 mr-3 w-full rounded-lg inputbox text-white 
                        placeholder:text-gray-200 outline-none border-2 sm:mx-0 border-opacity-10'
                        />
                    </div>


                    <p className='bg-blue-900 text-white mt-5 py-2 px-28 w-fit
           rounded-md hover:bg-blue-600 transition-colors duration-300 text-xl mx-[10vw] sm:mx-0
           ...
           rounded-md hover:bg-slate-900 transition-colors duration-300 mx-[10vw] sm:mx-0
           ease-in-out'>
                        Already have an account? <Link to='/login' className='text-slate-200 hover:text-slate-200'>Log in here</Link>
                    </p>
